		...
		- 3) Die Aufgaben a) - c) können unabhängig voneinander gelöst werden.
		  ...
		  collapsed:: true
			- a) Gegeben ist das [[lineare]], [[zeitinvariante]] System
			  background-color:: green
			  collapsed:: true
			  ![img](../assets/documents/AUT-2022-02-04-3a.webp)
				- i) Berechnen Sie die [[Übertragungsfunktion]] $G(s)$ vom Eingang $u$ zum Ausgang $y$.
				  background-color:: green
				- ii) Für die [[transfer functions]] gelte nun ${G_1(s)} = \frac{1}{as+1}$, $G_2(s) = V_2$, ${G_3(s) = \frac{1}{s}}$ und ${G_4 = \frac{1} {s+2}}$ , mit $V_2 > 0$. Für welche Werte von $a$ ist die [[Übertragungsfunktion]] [[BIBO-stabil]]?
				  background-color:: green
			- b) Für die [[Übertragungsfunktion]]
			  ...
			  ![img](../assets/documents/AUT-2022-02-04-3b.webp)
...
- ## flashcards
  collapsed:: true
	...
	- wie schaut ein allgeimeines lineares system aus?
	  ...
	  collapsed:: true
		-
		- ![img](../assets/documents/allgemeines-lineares-system.webp)
	...
	- was ist eine [[trajektorie]]?
	  ...
	  collapsed:: true
		...
		- ![img](../assets/documents/AUT-2022-11-22-trajektorie.webp)
	...
	- wofür braucht man die [[zustandstransformation]]?
	  ...
	  id:: 6729bee5-97f3-44a9-b04d-0f656ffdf0ba
		...
		- ![img](../assets/documents/zustandstranformation-motivation.webp)
